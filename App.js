...
const Header = () => {
    ...
    <div className="header">
        <div className="logo-container">
            <img className="logo" src="https://cdn2.f-cdn.com/contestentries/2426851/74260034/6689bc27dfb41_thumb900.jpg"></img>
        </div>
...
// to give inline styles will write 
const styleCard = {
    backgroundColor: "#f0f0f0",
};

// we can also give css like this
// <div className="res-card" style={{  backgroundColor: "#f0f0f0" }}>

// const ReasturantCards = (props) => {
// instead of this we can also destructing on the fly this destructuring is javascript not react
// const ReasturantCards = ({resName,cuisines}) => {
...
const resList = [          
  {
    ...
    "analytics": {
      "context": "seo-data-0ff9c900-3151-4fc6-8244-42dc2efd3c4d"
    },
    "cta": {
  ...
  },
  {
    "info": {
      ...
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2025/2/18/ab7631ef-edbd-45b1-9e98-ab99f6aa7d76_59146.jpg",
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2025-02-24 22:30:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2025-02-24 22:59:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
